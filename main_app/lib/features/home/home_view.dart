...
import 'package:taxi_grad/core/widgets/icon_title_subtitle_button.dart';
import 'package:taxi_grad/features/home/run_ride_view.dart';
import 'package:taxi_grad/features/home/tip_request_view.dart';
  ...
  void initState() {
    ...
    if (ServiceCall.userType == 2) {
      ...
      SocketManager.shared.socket?.on("new_ride_request", (data) async {
        printHere("new_ride_request socket get :${data.toString()} ");
                  ...
                  children: [
                    ...
                    if (isOpen)
                      Container(
                        ...
                        color:
                            TColor.placeholder.withAlpha((0.5 * 255).round()),
                      ),
                    if (isOpen)
                      Row(
